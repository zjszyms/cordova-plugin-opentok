...
public class OpenTokAndroidPlugin extends CordovaPlugin implements
	...
	public RunnableSubscriber runsub;
	...
	public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
		...
		if (action.equals("initPublisher")) {
			...
			runsub.mSubscriber.setSubscribeToAudio(subscribeAudio);
			...
			Log.i(TAG, "setting subscribeVideo");
			runsub.mSubscriber.setSubscribeToVideo(subscribeVideo);
		}
